...
function buildPrompt(
  ...
  return [
    ...
    "- videoSeconds should be one of 4, 8, or 12 when the user explicitly requests a supported video duration. Leave it empty when not specified.",
    "- videoSize should be one of 720x1280, 1280x720, 1024x1792, or 1792x1024 when the user explicitly requests a supported format or orientation. Leave it empty when not specified.",
