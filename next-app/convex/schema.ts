...
import {
  ...
  persistedChainEnvironmentValidator,
  cartStatusValidator,
...
const storedChainEnvironmentValidator = persistedChainEnvironmentValidator;
const optionalStoredChainEnvironmentValidator = v.optional(
  persistedChainEnvironmentValidator,
);
...
export default defineSchema({
  ...
  profiles: defineTable({
    ...
    walletEnvironment: optionalStoredChainEnvironmentValidator,
    walletNetworkKey: v.optional(storedNetworkKeyValidator),
  ...
  walletAccounts: defineTable({
    ...
    createdAt: v.number(),
    environment: storedChainEnvironmentValidator,
    isDefaultBuyer: v.boolean(),
    isDefaultPayout: v.boolean(),
    lastSyncedAt: v.number(),
    metadataJson: v.optional(v.string()),
    networkKey: v.optional(storedNetworkKeyValidator),
  ...
  intents: defineTable({
    ...
    category: v.string(),
    classification: v.optional(requestClassificationValidator),
  ...
  checkouts: defineTable({
    ...
    createdAt: v.number(),
    currency: v.string(),
    environment: optionalStoredChainEnvironmentValidator,
    itemCount: v.number(),
    ownerUserId: v.optional(v.string()),
  ...
  agentRequestSessions: defineTable({
    ...
    message: v.string(),
    mode: v.literal("auto"),
    networkKey: storedNetworkKeyValidator,
