  ...
  return (
    <Streamdown
      className={cn(
        ...
        "[&_h2]:mt-20 [&_h2]:max-w-4xl [&_h2]:font-editorial [&_h2]:text-[2rem] [&_h2]:leading-[1.06] [&_h2]:font-semibold [&_h2]:tracking-[-0.03em] sm:[&_h2]:text-[2.45rem]",
        "[&_h3]:mt-12 [&_h3]:max-w-4xl [&_h3]:font-heading [&_h3]:text-[1.05rem] [&_h3]:leading-7 [&_h3]:font-semibold [&_h3]:tracking-tight sm:[&_h3]:text-[1.2rem]",
