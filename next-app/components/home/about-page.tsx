...
import { getPublicPaperHref, listFeaturedPublicPapers } from "@/lib/boreal/papers"
  ...
  return (
    <main id="main-content" className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex min-h-screen w-full max-w-[1480px] flex-col px-4 py-4 sm:px-6 sm:py-6 lg:px-8">
        ...
        <section className="grid gap-4 py-8 lg:grid-cols-[minmax(0,1.08fr)_minmax(22rem,0.92fr)] lg:py-10">
        ...
        <section className="grid gap-4 lg:grid-cols-[minmax(0,0.96fr)_minmax(0,1.04fr)]">
          <div className="border border-border bg-muted/16">
            <div className="border-b border-border px-4 py-3 sm:px-5">
              <p className="text-[11px] uppercase tracking-[0.22em] text-muted-foreground">
                Core flow
              </p>
