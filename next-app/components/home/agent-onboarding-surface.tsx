  ...
  const content = (
    <div className="mx-auto flex w-full max-w-[1480px] flex-col gap-4">
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        <Card className="rounded-[1.35rem] border border-border/80 bg-card/92 py-0 shadow-[0_18px_44px_-36px_rgba(15,23,42,0.18)] lg:col-span-3">
          <CardHeader className="gap-3 border-b border-border/70 px-4 py-4 sm:px-5">
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="max-w-4xl text-sm/7">
                Keep this route separate from generic Boreal chat. It is the
                Solana-specific specialist for non-custodial execution plans,
                wallet requirements, approval checklists, and risk notes. It is
                planning-only today and does not imply hidden custody.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className="flex flex-wrap gap-3 px-4 py-4 sm:px-5">
            ...
            <Button asChild className="rounded-full" variant="outline">
              <Link href="/agent-registry.md">Read registry entry</Link>
            </Button>
            <Button asChild className="rounded-full" variant="outline">
              <Link href="/one-request-api.md">Use one request</Link>
            </Button>
          </CardContent>
        </Card>
