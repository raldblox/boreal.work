...
- `2026-04-29`: Tightened Solana specialist truthfulness: `solana-operator` is now documented and exposed as planning-only until Boreal wires a real Solana wallet adapter, signer methods, transaction preview, and explicit approval flow into execution.
