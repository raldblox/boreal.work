...
- `2026-04-28`: Hardened Boreal's video route contract: video requests now default to `8` seconds at `1280x720`, unsupported durations or sizes are rejected before approval, provider-unavailable Sora errors are surfaced more honestly, and `npm run smoke:video-route` verifies the request policy.
