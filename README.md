...
- `next-app/app/account` is the dedicated settings surface for public profile setup, service or product offer authoring, provider-sync boundaries, wallet sync, and payout defaults.
