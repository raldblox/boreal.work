...
- Boreal now includes `solana-operator` as a direct specialist for non-custodial Solana execution planning, while keeping the no-hidden-custody boundary explicit.
